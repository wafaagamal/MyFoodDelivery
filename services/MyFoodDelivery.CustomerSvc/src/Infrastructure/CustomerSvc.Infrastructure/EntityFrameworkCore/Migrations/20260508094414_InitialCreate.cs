        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalToken = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsDefault = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerAddresses_Customer_Default_Active",
                table: "CustomerAddresses",
                columns: new[] { "CustomerId", "IsDefault", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_CustomerPaymentMethods_Customer_Default_Active",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_LastOrderDate",
                table: "Customers",
